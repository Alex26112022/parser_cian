...
def interactive_func():
    ...
    while True:
        ...
        # max_price_ = input('Введите минимальную стоимость или нажмите '
        #                    'ENTER!\n')
        ...
        material_type = ''
        print('Выберите материал постройки!\n'
              '\t1. Кирпичный\n'
              '\t2. Монолитный\n'
              '\t3. Панельный\n'
              '\t4. Блочный\n'
        ...
        material_type_ = input()
        if material_type_ in ['1', '2', '3', '4', '5', '6', '7', '8']:
            material_type = int(material_type_)

        return material_type


if __name__ == '__main__':
    print(interactive_func())
